      ...
      <Container>
        ...
        <div ref={product1Ref} className="product-section mb-32 opacity-0 relative z-10">
          ...
          <div className="relative h-[600px] lg:h-[700px] mb-16">
            {/* Dashboard - Back */}
            <div className="absolute top-0 left-[5%] w-[70%] lg:top-0 lg:left-[5%] lg:w-[70%] z-10 ccm-image-1">
            ...
            {/* Billing - Middle */}
            <div className="absolute top-[180px] right-[10%] w-[65%] lg:top-[120px] lg:right-[10%] lg:w-[65%] z-20 ccm-image-2">
              <div className="rounded-2xl overflow-hidden shadow-2xl border-2 border-white bg-white">
                <img
            ...
            {/* Monitoring - Front */}
            <div className="absolute top-[360px] left-[15%] w-[60%] lg:bottom-0 lg:top-auto lg:left-[15%] lg:w-[60%] z-30 ccm-image-3">
              <div className="rounded-2xl overflow-hidden shadow-2xl border-2 border-white bg-white">
                <img
